...
const cases: Case[] = [
  ...
  },
  {
    ...
    role: 'Fullstack',
    description:
      'Лендинг + NestJS API + AI-помощник. Сделан за [N] часов. Без шаблонов, всё руками (с помощью Claude как ассистента). Полный цикл: форма → валидация → SMTP → 2 письма + AI-чат поверх профиля.',
